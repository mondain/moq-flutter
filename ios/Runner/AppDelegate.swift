...
/// Native audio/video capture plugin for iOS using AVFoundation
public class NativeCapturePlugin: NSObject, FlutterPlugin {
    ...
    private var audioStreamHandler: IOSAudioStreamHandler?
    private var videoStreamHandler: IOSVideoStreamHandler?
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        instance.audioStreamHandler = IOSAudioStreamHandler()
        ...
        instance.videoStreamHandler = IOSVideoStreamHandler()
    ...
    @objc private func handleInterruption(notification: Notification) {
        ...
        switch type {
        case .began:
            // Interruption began, pause capture
            captureSession?.stopRunning()
        case .ended:
            // Interruption ended, resume if we were capturing
            if isAudioCapturing || isVideoCapturing {
    ...
    private func handleInitializeAudio(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        do {
            ...
            try audioSession.setPreferredSampleRate(Double(audioSampleRate))
    ...
    private func setupVideoCapture() throws {
        ...
        // Get video device (default to back camera on iOS)
...
class IOSAudioStreamHandler: NSObject, FlutterStreamHandler {
...
class IOSVideoStreamHandler: NSObject, FlutterStreamHandler {
    var eventSink: FlutterEventSink?
